...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "inventoryapp14/test/integration/FirstJourney",
    "inventoryapp14/test/integration/ProductsListJourney",
    "inventoryapp14/test/integration/ProductsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
